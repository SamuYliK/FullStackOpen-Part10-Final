...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(firstRepositoryItem).not.toHaveTextContent('async-library/react-async');
      expect(firstRepositoryItem).toHaveTextContent('Build forms in React, without the tears');
      expect(firstRepositoryItem).not.toHaveTextContent('Flexible promise-based React data loader');
      ...
      expect(firstRepositoryItem).not.toHaveTextContent('69');
      ...
      expect(firstRepositoryItem).not.toHaveTextContent('72');
      ...
      expect(secondRepositoryItem).not.toHaveTextContent('Build forms in React, without the tears');
      ...
      expect(secondRepositoryItem).not.toHaveTextContent('1.6k');
      expect(secondRepositoryItem).toHaveTextContent('69');
      expect(secondRepositoryItem).not.toHaveTextContent('21.9k');
      expect(secondRepositoryItem).toHaveTextContent('1.8k');
      expect(secondRepositoryItem).not.toHaveTextContent('88');
